...
class Main extends PureComponent {
  handleSwitchLanguage = ({ key }) => {
    ...
    dispatch({
      ...
      payload: {
        lang: key,
        language: import(`languages/${key}`).default
      }
    });
  };
        ...
        <header className={styles.header}>
          <div className="wrapper">
            ...
            <div className={styles.headerRight}>
              <Link className={styles.signin} to="/join/signin">
                {language['登录']}
              </Link>
              <Link className={styles.signup} to="/join/signup">
                {language['注册']}
              </Link>
              <Dropdown
                overlay={
                  <Menu onClick={this.handleSwitchLanguage}>
                    <Menu.Item key="en_US">
                      <img src={en_US_Flag} alt="English" /> English
                    </Menu.Item>
                    <Menu.Item key="zh_CN">
                      <img src={zh_CN_Flag} alt="中文" /> 中文
                    </Menu.Item>
                  </Menu>
                }
              >
                <a className={('ant-dropdown-link', styles.language)} href="javascript:;">
                  <img src={eval(`${lang}_Flag`)} alt={mapToLang[lang]} /> {mapToLang[lang]}{' '}
                  <Icon type="down" />
                </a>
              </Dropdown>
            </div>
